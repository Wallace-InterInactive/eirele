...
function R$3(a, b2, e, d2, c2) {
  ...
  if (h2) return h2 = a, c2 = c2(h2), a = "" === d2 ? "." + Q$3(h2, 0) : d2, I$4(c2) ? (e = "", null != a && (e = a.replace(P$4, "$&/") + "/"), R$3(c2, b2, e, "", function(a2) {
    return a2;
  })) : null != c2 && (O$3(c2) && (c2 = N$3(c2, e + (!c2.key || h2 && h2.key === c2.key ? "" : ("" + c2.key).replace(P$4, "$&/") + "/") + a)), b2.push(c2)), 1;
  h2 = 0;
  d2 = "" === d2 ? "." : d2 + ":";
  ...
  else if (f2 = A$4(a), "function" === typeof f2) for (a = f2.call(a), g2 = 0; !(k2 = a.next()).done; ) k2 = k2.value, f2 = d2 + Q$3(k2, g2++), h2 += R$3(k2, b2, e, f2, c2);
...
react_production_min$1.Children = { map: S$4, forEach: function(a, b2, e) {
  S$4(a, function() {
...
function q$3(c2, a, g2) {
  ...
  return { $$typeof: k$3, type: c2, key: e, ref: h2, props: d2, _owner: n$2.current };
}
...
function v$3(a, b2, c2, d2, e, f2, g2) {
...
function ed(a, b2, c2, d2) {
  var e = C$3, f2 = cd.transition;
  cd.transition = null;
  try {
    C$3 = 1, fd(a, b2, c2, d2);
  } finally {
    C$3 = e, cd.transition = f2;
  }
}
...
function Wh(a) {
  ...
  if (null !== a) {
    e = a;
    do
      f2 = e.lane, M$3.lanes |= f2, rh |= f2, e = e.next;
    while (e !== a);
...
function Zh(a, b2) {
  var c2 = M$3, d2 = Uh(), e = b2(), f2 = !He(d2.memoizedState, e);
...
function Pk(a, b2, c2) {
  var d2 = C$3, e = ok.transition;
  try {
    ok.transition = null, C$3 = 1, Wk(a, b2, c2, d2);
  } finally {
    ok.transition = e, C$3 = d2;
  }
  return null;
}
...
function R$1(a, b2, e, d2, c2) {
  ...
  if (h2) return h2 = a, c2 = c2(h2), a = "" === d2 ? "." + Q$1(h2, 0) : d2, I$2(c2) ? (e = "", null != a && (e = a.replace(P$2, "$&/") + "/"), R$1(c2, b2, e, "", function(a2) {
    return a2;
  ...
  else if (f2 = A$2(a), "function" === typeof f2) for (a = f2.call(a), g2 = 0; !(k2 = a.next()).done; ) k2 = k2.value, f2 = d2 + Q$1(k2, g2++), h2 += R$1(k2, b2, e, f2, c2);
  else if ("object" === k2) throw b2 = String(a), Error("Objects are not valid as a React child (found: " + ("[object Object]" === b2 ? "object with keys {" + Object.keys(a).join(", ") + "}" : b2) + "). If you meant to render a collection of children, use an array instead.");
  return h2;
}
function S$2(a, b2, e) {
...
const c$1 = (e) => "number" == typeof e && !isNaN(e), d$1 = (e) => "string" == typeof e, u$1 = (e) => "function" == typeof e, m$1 = (e) => reactExports.isValidElement(e) || d$1(e) || u$1(e) || c$1(e);
function f$1(e, t2, n2) {
  void 0 === n2 && (n2 = 300);
  ...
  return function(t3) {
    ...
    return reactExports.useLayoutEffect(() => {
      ...
      const e = g2.current, t4 = () => {
        e.removeEventListener("animationend", t4), l2 ? f$1(e, m2, c2) : m2();
      };
...
function I$1(e, t2) {
  var n2;
  if (t2) return !(null == (n2 = v$1.get(t2)) || !n2.isToastActive(e));
  let o = false;
...
function _$1(e, t2) {
  m$1(e) && (b$1() || h$1.push({ content: e, options: t2 }), v$1.forEach((n2) => {
    n2.buildToast(e, t2);
  }));
}
function C$1(e, t2) {
...
const k$1 = () => "" + w$1++;
function P$1(e) {
  return e && (d$1(e.toastId) || c$1(e.toastId)) ? e.toastId : k$1();
}
function M$1(e, t2) {
  return _$1(e, t2), t2.toastId;
}
function x$1(e, t2) {
  return { ...t2, type: t2 && t2.type || e, toastId: P$1(t2) };
}
function A$1(e) {
  return (t2, n2) => M$1(t2, x$1(e, n2));
}
function B$1(e, t2) {
  return M$1(e, x$1("default", t2));
}
B$1.loading = (e, t2) => M$1(e, x$1("default", { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...t2 })), B$1.promise = function(e, t2, n2) {
  ...
  const i = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null }, l2 = (e2, t3, s2) => {
    ...
    const a2 = { type: e2, ...i, ...n2, data: s2 }, r3 = d$1(t3) ? { render: t3 } : t3;
    return o ? B$1.update(o, { ...a2, ...r3 }) : B$1(r3.render, { ...a2, ...r3 }), s2;
  }, c2 = u$1(e) ? e() : e;
  return c2.then((e2) => l2("success", r2, e2)).catch((e2) => l2("error", a, e2)), c2;
}, B$1.success = A$1("success"), B$1.info = A$1("info"), B$1.error = A$1("error"), B$1.warning = A$1("warning"), B$1.warn = B$1.warning, B$1.dark = (e, t2) => M$1(e, x$1("default", { theme: "dark", ...t2 })), B$1.dismiss = function(e) {
  !function(e2) {
    var t2;
    if (b$1()) {
      if (null == e2 || d$1(t2 = e2) || c$1(t2)) v$1.forEach((t3) => {
        t3.removeToast(e2);
      });
      else if (e2 && ("containerId" in e2 || "id" in e2)) {
        const t3 = v$1.get(e2.containerId);
        t3 ? t3.removeToast(e2.id) : v$1.forEach((t4) => {
          t4.removeToast(e2.id);
        });
      }
    } else h$1 = h$1.filter((t3) => null != e2 && t3.options.toastId !== e2);
  }(e);
}, B$1.clearWaitingQueue = function(e) {
  void 0 === e && (e = {}), v$1.forEach((t2) => {
  ...
  const n2 = ((e2, t3) => {
    ...
    return null == (n3 = v$1.get(o || 1)) ? void 0 : n3.toasts.get(e2);
  })(e, t2);
  if (n2) {
    const { props: o, content: s } = n2, a = { delay: 100, ...o, ...t2, toastId: t2.toastId || e, updateId: k$1() };
...
}, B$1.play = (e) => C$1(true, e), B$1.pause = (e) => C$1(false, e);
const S$1 = function(e, t2) {
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports$1.jsxs(React$1.StrictMode, { children: [
